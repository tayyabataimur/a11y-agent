...
export const PATCH_REGISTRY: Record<string, StrategyEntry> = {
  "image-alt": {
    meta: {
      ...
      wcag: "WCAG 1.1.1 Non-text Content (Level A)",
      explanation: "Inserts alt=\"\" as a draft. Decorative images stay alt=\"\"; informative images need descriptive text. Requires human review — empty alt on informative content is an automated-pass/manual-fail outcome.",
    },
  ...
  "button-name": {
    meta: {
      ...
      frameworks: ["html", "react", "nextjs", "vue", "svelte", "astro"],
      wcag: "WCAG 4.1.2 Name, Role, Value (Level A)",
      explanation: "Inserts a placeholder aria-label as a draft. Replace with the real action name; placeholder text satisfies axe but fails screen-reader review.",
    },
  ...
  "link-name": {
    meta: {
      ...
      frameworks: ["html", "react", "nextjs", "vue", "svelte", "astro"],
      wcag: "WCAG 2.4.4 Link Purpose (Level A)",
      explanation: "Inserts a placeholder aria-label as a draft. Replace with the real destination; placeholder text satisfies axe but fails screen-reader review.",
    },
